    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Gym floor access, standard hours.", 30, true, "Basic", 1499m },
                    { 2, "All classes + personal training discount.", 30, true, "Premium", 2999m },
                    { 3, "24/7 access, all classes, monthly PT session.", 30, true, "Elite", 4999m }
                });
