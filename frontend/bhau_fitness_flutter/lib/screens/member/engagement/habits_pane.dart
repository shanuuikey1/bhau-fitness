                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        minHeight: 6,
                        backgroundColor: BhauColors.bg3,
                        valueColor: const AlwaysStoppedAnimation(BhauColors.ok),
                      ),
                    ),
                    const SizedBox(height: 4),
                    Text('${total == 0 ? 0 : (doneCount / total * 100).round()}% of today\'s goals done',
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(engagement.habitIcon(key), style: const TextStyle(fontSize: 18)),
                  ],
                ),
              ),
            ),
